...
return [
	...
	"productcategories" => [
	"already_exists" => "That Productcategory already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Productcategory. Please try again.",
	"delete_error" => "There was a problem deleting this Productcategory. Please try again.",
	"not_found" => "That Productcategory does not exist.",
	"update_error" => "There was a problem updating this Productcategory. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
